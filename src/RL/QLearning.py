...
class QLearning:
    ...
    def __init__(self, numFeatures, features, numActions, memorySize, epsilon, numTilings, tableDimensionality, delta,
                 alpha, gamma, layerObj):
        ...
        self.cmac = CMAC(alpha, numFeatures, 1, memorySize, gamma, numTilings, tableDimensionality)

    def initializeState(self):

        self.currentState = State(self.numFeatures)
        self.nextState = State(self.numFeatures)
        ...
        self.T = Tuple(self.currentState, self.currentAction, self.currentReward, self.nextState, self.nextAction)
    ...
    def populateCMACs(self, s, a):
        ...
        if (0):
            print("PopulateCMACs: FloatInputs: ", self.cmac.floatInputs, "IntInputs: ", self.cmac.intInputs)
        return
    ...
    def printQLearningParams(self):
        # print ( "\nInitializing QLearning Object for layer: ", self.layerObj.desc ) print ( "Bellman Error: ",
        # self.bellmanError, "Num Features: ", self.numFeatures, "Num Actions: ", self.numActions, "Delta: ",
        # self.delta, "Gamma: ", self.gamma,  "Alpha: ", self.alpha )
