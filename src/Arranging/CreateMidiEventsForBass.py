...
def CreateMidiEventsForPiano(layer, uniqCPId, secId, chId, repCount, numChordsInSection, sectionChordData,
                             movementLayerData):
    globalStartTick = sectionChordData['globalStartTick']
    globalEndTick = sectionChordData['globalEndTick']
    ...
    if (repCount == 1):  # make all chords simple
        ...
        if (phraseNum == 2 and actualChordId == numChordsInSection - 1):  # last chord in second phrase
            type = 'complex'
        elif (phraseNum == 3 and (
                actualChordId == numChordsInSection - 1 or actualChordId == 0)):  # last or first chord in second phrase
            type = 'complex'
        elif (phraseNum > 3):
...
def CreateMidiEventsForRhythmChords(layer, uniqCPId, secId, chId, repCount, numChordsInSection, sectionChordData,
                                    movementLayerData):
    globalStartTick = sectionChordData['globalStartTick']
    globalEndTick = sectionChordData['globalEndTick']
...
def CreateMidiEventsForStrings(layer, uniqCPId, secId, phId, repCount, numChordsInSection, sectionPhraseData,
                               movementLayerData):
...
def CreateMidiEventsForPercussions(layer, density, uniqCPId, secId, phId, repCount, numChordsInSection, fills,
                                   sectionPhraseData, movementLayerData):
    globalStartTick = sectionPhraseData['globalStartTick']
    globalEndTick = sectionPhraseData['globalEndTick']
...
def CreateMidiEventsForPercussionFills(layer, uniqCPId, secId, phId, repCount, numChordsInSection, fills,
                                       sectionPhraseData, movementLayerData):
    globalStartTick = sectionPhraseData['globalStartTick']
    globalEndTick = sectionPhraseData['globalEndTick']
