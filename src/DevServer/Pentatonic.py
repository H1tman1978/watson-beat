...
class PMelody:
    ...
    def run(self):
        ...
        while usedTicks < self.duration:
            ...
            chosenData = {'action': 'Pentatonic', 'notes': chosenNote, 'pitches': pitch, 'chord': self.homeChord,
                          'scale': self.homeScale, 'duration': chosenDuration, 'totalDuration': totalDuration}
    ...
    def populateAdditionalChordsOfSameDuration(self, items):
        ...
        for id in range(1, numChords, 1):
            ...
            for item in items:
                ...
                newItem = {'action': 'Pentatonic', 'notes': newNotes, 'pitches': pitch, 'chord': chord, 'scale': scale,
                           'duration': duration}
