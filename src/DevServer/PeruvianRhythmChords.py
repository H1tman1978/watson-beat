    ...
    def run(self):
        ...
        if (self.tse == '3/4'):
            ...
            if (self.duration in Constants.OtherChordDurationBreakdown):
                ...
                chordSplitDuration = list(chain.from_iterable(
                    chordSplitDuration))  # flatten array of arrays
        ...
        for cSplit in range(len(chordSplitDuration)):
            if (cSplit == 0):  # first item in the split
                ...
                split = random.choice(
                    [chordSplitDuration[cSplit], chordSplitDuration[cSplit] / 2, chordSplitDuration[cSplit] / 4])
        ...
        if (0):
            print("simple chordSplitDuration: ", chordSplitDuration, "complex chordSplitDuration: ",
                  complexChordSplitDuration)
        ...
        for chordSplits in [chordSplitDuration, complexChordSplitDuration]:
            ...
            for item in range(len(chordSplits)):
                ...
                for cNoteIndex in range(numNotes):
                    ...
                    eventItems.append({'action': 'peruvianRhythmChords', 'notes': [cNote], 'cNoteIndex': cNoteIndex,
                                       ...
                                       'duration': [chordSplits[item]], 'octaves': [octave], 'velocity': velocity})
