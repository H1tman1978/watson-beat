...
from . import (AccompanyingLayers, Constants)
from . import (Bass1, Bass2, Bass3, Rhythm, BrassRhythms)
...
class Section:
    ...
    def initializeAndRunBass2(self):
        ...
        for chordId in range(len(self.rhy.ChordDurations)):
            ...
            if (0):
                print("Initializing Chord: ", chordId, " Scale: ", scale, "Chord: ", chord, "Duration: ", duration,
                      "Rhythm: ", rhythm)
    ...
    def initializeAndRunBass3(self):
        ...
        for chordId in range(numChords):
            ...
            if (0):
                print()
                print("Initializing Chord: ", chordId, " Scale: ", scale, "Chord: ", chord, "Duration: ", duration,
                      "Rhythm Options: ", rhythmOptions, "chosen rhy option: ", bassRhy)
    ...
    def runAccompanyingLayers(self, layers):
        ...
        accompanyingLayers = AccompanyingLayers.AccompanyingLayers(layers, self.bass1Obj, self.rhy.UniqueChordDurations,
                                                                   self.chordDict, self.wbLevers)
