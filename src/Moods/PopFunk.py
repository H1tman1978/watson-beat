...
from Arranging.Arranging import Arranging
from Skeleton import Constants
from Skeleton import MusicTheory

from .InitializeChordsAndPhraseHelper import InitializeChordsAndPhraseForSections
from .InitializeSectionsHelper import InitializeSectionsComplex
...
class PopFunk:
    ...
    def __init__(self, movement, selectedTempo):
        ...
        self.groupLayers = {
            'rhythm': {'layers': ['bass3', 'bass2', 'drumsKit', 'rightPiano', 'rightPiano2', 'rhythmChords'],
                       'heavy': 6, 'lite': 2, 'medium': 4},
