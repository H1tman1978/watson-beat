...
from Skeleton.Constants import *
from Skeleton.MusicTheory import *

from .InitializeChordsAndPhraseHelper import *
from .InitializeSectionsHelper import *
...
class Anthematic:
    ...
    def InitializeMoodForSimple(self, sections):
        ...
        self = InitializeSectionsComplex(self, sections, moodSpecificInfo)

        # sys.exit(0)
        # self.keepHalfOfPrevLayers = True
        # self.keepHalfOfPrevLayers = False

        self = InitializeChordsAndPhraseForSections(self, sections)
    ...
    def setPercussionSettings(self, tse):
        ...
        halfBeats = TSEBeatInfo[tse]['halfBeats']
        strongDownBeats = TSEBeatInfo[tse]['strongDownBeats']
        weakDownBeats = TSEBeatInfo[tse]['weakDownBeats']
        numBeats = TSEs[tse]['num16thBeats']
